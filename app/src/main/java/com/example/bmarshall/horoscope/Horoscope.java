...
/**
 * Created by bmarshall on 1/10/17.
 */
...
public class Horoscope {
    ...
    public static final Horoscope[] horoscopes = new Horoscope[] {
            ...
            new Horoscope("Libra",          "Scales",       "Libras are famous for maintaining balance and harmony",                  "October",   "That run for the record books once again falls short when you start Boston’s all-time second-largest fire"),
